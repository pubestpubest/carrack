      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <div className="space-y-1">
            <label className="block text-xs tracking-wider" style={{ color: '#4a5568' }}>CAPTAIN NAME</label>
            <input
              type="text"
              required
              minLength={3}
              ...
              className={INPUT}
              placeholder="Your captain's name"
            />
          </div>
          ...
          >
            {loading ? 'Setting sail…' : 'Register'}
          </button>

          <p className="text-center text-xs" style={{ color: '#4a5568' }}>
            Already enlisted?{' '}
            <Link href="/auth/login" className="transition-colors" style={{ color: 'var(--brass)' }}>
              Sign in
            </Link>
          </p>
        </form>
